...
then
```bash
treease '.a.nested | parent' sample.yml
```
will output
```yaml
nested: cat
...
then
```bash
treease '.. | select(. == "banana") | parent' sample.yml
```
will output
```yaml
fruit: banana
...
then
```bash
treease '.. | select(. == "banana") | parent.name' sample.yml
```
will output
```yaml
sam
...
then
```bash
treease '.a.b.c | parents' sample.yml
```
will output
```yaml
- c: cat
...
then
```bash
treease '.a.b.c | parent(-1)' sample.yml
```
will output
```yaml
a:
...
then
```bash
treease '.a.b.c | parent(2)' sample.yml
```
will output
```yaml
b:
...
then
```bash
treease '.a.b.c | parent(3)' sample.yml
```
will output
```yaml
a:
