...
```bash
treease 'first(.a == "cat")' sample.yml
```
...
```bash
treease 'first(.a == true)' sample.yml
```
...
```bash
treease 'first(.a != null)' sample.yml
```
...
```bash
treease 'first(.b > 4 and .b < 6)' sample.yml
```
...
```bash
treease '.items | first(.a == "cat")' sample.yml
```
...
```bash
treease 'first(.a == "dog")' sample.yml
```
...
```bash
treease 'first(. == "hello")' sample.yml
```
...
```bash
treease 'first(.a | test("^c"))' sample.yml
```
...
```bash
treease 'first(.a | length > 4)' sample.yml
```
