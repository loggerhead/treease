...
{#if state.visible}
  <div class="pointer-events-none absolute bottom-4 right-4 z-10 w-72 rounded-[12px] border border-[#e2e8f0] bg-white/95 p-3 shadow-[0_12px_28px_rgba(15,23,42,0.14)] backdrop-blur">
