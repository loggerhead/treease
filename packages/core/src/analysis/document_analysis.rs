...
use crate::language::lang_spec::{self, has_structured_path, parse_tree, query_from_language};
use crate::language::semantic_tokens::{
    collect_token_spans_with_tree, encode_and_cache_semantic_tokens,
};
use crate::language::tree_sitter_support::tree_sitter_language_for_spec;
use crate::stream::streaming_json;
use crate::tree::tree_node::{NodeId, TreeNodeKind};
        ...
        "json" => {
            ...
            StoredDocumentAnalysisOwned {
                ...
                ts_tree: if stored_demand.ts_tree {
                    crate::language::lang_spec::parse_tree(language_name, source)
                } else {
                    None
                },
                token_spans,
...
fn encode_scalar(store: &TreeStore, id: NodeId, out: &mut String) -> Option<()> {
        ...
        .unwrap_or(SemType::Str)
    {
        ...
        SemType::Boolean => {
            match crate::operators::core_helpers::parse_bool(store.value_for(id).ok()?) {
