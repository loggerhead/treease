use super::graph_builder::{BuilderConfig, GraphLanguage, GraphModel, PathSeg};
use super::graph_materialize::materialize_into_current_model;
use super::graph_shape::NodeShapeBuilder;
use super::graph_topology::GraphTopology;
use super::layout_engine::LayoutEngine;
use super::{NodeId, TreeStore};

#[derive(Debug, Clone)]
pub(crate) struct FullGraphBuild {
    pub(crate) model: GraphModel,
    pub(crate) topology: GraphTopology,
    pub(crate) layout_state: crate::core::layout_engine::LayoutState,
}
...
impl FullLayoutAdapter {
    ...
    pub(crate) fn build_model_with_runtime_state(
        ...
        let mut layout_state = crate::core::layout_engine::LayoutState::default();
