...
pub(super) fn open_batch(request_seq: u64, events: Vec<DocumentEvent>) -> EventBatch {
    EventBatch {
        request_seq,
        events,
        terminal: None,
...
fn snapshot_ready_event(
    ...
    analysis: &super::super::snapshot::AnalysisBundle,
    graph: Option<&super::super::snapshot::GraphProjection>,
    output: &OutputPlan,
) -> Result<DocumentEvent, String> {
    let analysis_payload = output
        .analysis
        .then(|| super::super::snapshot::analysis_payload_from_bundle(analysis, false));
...
fn parse_failed_events(
    ...
    vec![
        DocumentEvent::ParseFailed {
            snapshot_id,
            analysis: super::super::snapshot::analysis_payload_from_bundle(analysis, false),
        },
...
mod tests {
    ...
    fn validate_snapshot_ready_outputs_accepts_requested_graph_data() {
        let graph = crate::document::snapshot::GraphProjection {
            ready: true,
            clear: true,
    ...
    fn advance_job_apply_edits_with_base_snapshot_emits_snapshot_ready() {
        ...
        let base_result = crate::document::materialize(
    ...
    fn analyze_source_snapshot_carries_tree_path_index_for_graph_output() {
        ...
        let path = [
            crate::tree::path_seg_key("wide"),
            crate::tree::path_seg_key("target"),
        ];
    ...
    fn structural_incremental_analysis_uses_reused_line_index_and_keeps_snapshot_ready() {
        ...
        let base = crate::document::materialize(
            &DocumentInputPlan::SourceText,
            "doc-json",
            "json",
            source,
    ...
    fn structural_incremental_preserves_spans_after_length_changing_edit() {
        ...
        let result = crate::document::materialize_with_base(
        ...
        let tail_id = crate::tree::find_node_by_path(
            document.root,
            &[crate::tree::path_seg_key("tail")],
            false,
            &document.store,
        )
    ...
    fn structural_incremental_remains_resumable_across_two_scalar_edits() {
        ...
        let first = crate::document::materialize(
            &DocumentInputPlan::SourceText,
            "doc-repeat",
            "json",
            first_source,
        ...
        let second = crate::document::materialize_with_base(
            &DocumentInputPlan::BaseTextWithEdits,
            "doc-repeat",
            "json",
            first_source,
        ...
        let third = crate::document::materialize_with_base(
            &DocumentInputPlan::BaseTextWithEdits,
            "doc-repeat",
            "json",
            second_source,
    ...
    fn structural_subtree_edit_recomputes_descendant_locations() {
        ...
        let node_id = crate::tree::find_node_by_path_with_index(
            document.root,
            &path,
            false,
            &document.store,
